...
**Cavab:** Bizim həllimiz "Human-in-the-loop" (İnsan nəzarətində olan) AI arxitekturasıdır. Yəni AI burada son qərarverici deyil, "Ağıllı Assistent" (Copilot) rolunu oynayır. 
**Bu necə baş verir?** Sistem auditi bitirdikdən sonra ekspertin ekranında AI-ın tapdığı hər bir uyğunsuzluğun yanında bir **"Sübut Linki"** və ya **"Qanun Maddəsi"** bloku çıxarır. Məsələn, AI deyir: *"Bu etiketdə şrift ölçüsü kiçikdir"*. Ekspert bu rəyin üzərinə kliklədikdə, ekranın sağ küncündə dərhal rəsmi sənədin (məs: AZS standartının) həmin tələbi yazılan hissəsi orijinal mətni ilə nümayiş olunur. Ekspert həm AI-ın rəyini, həm də AI-ın istinad etdiyi orijinal qanun maddəsini eyni ekranda görür. Yekun "Təsdiq" düyməsini yenə də mütəxəssis basır. Əvvəllər 30 dəqiqəyə etdiyi işi indi hazır təhlilə baxaraq 1 dəqiqəyə yekunlaşdırır. Məsuliyyət hər zaman insanda qalır, AI isə sadəcə "kitabı lazım olan səhifədən açıb mütəxəssisin qabağına qoyur".
